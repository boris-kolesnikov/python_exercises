...
while exit == False:
        ...
        print('Для ввода дробных чисел используй точки, а не запятые. Это важно, иначе ничего не заработает)')
        print(' ')
        print('Введите наименование измеряемого параметра и единицу  измерений [    ]  и нажмите клавишу Enter');
